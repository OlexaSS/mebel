...
DynamicAdapt.prototype.init = function () {
  ...
  var _loop = function _loop(_i3) {
    var media = _this2.mediaQueries[_i3];
  ...
  for (var _i3 = 0; _i3 < this.mediaQueries.length; _i3++) {
    _loop(_i3);
  }
};
...
burger.addEventListener('click', function () {
  burger.classList.toggle('icon-menu__active');
  menu.classList.toggle('menu__body_active');
}); //////////////////////////////////////////////////
//burger aside

var menuPageBurger = document.querySelector('.menu-page__burger');
var menuPageBody = document.querySelector('.menu-page__body');
...
if (isMobileOrTablet()) {
  var menuParents = document.querySelectorAll('.menu-page__parent>a');
  ...
  var _menuParents = document.querySelectorAll('.menu-page__parent');

  var _loop3 = function _loop3(_index) {
    var menuParent = _menuParents[_index];
  ...
  for (var _index = 0; _index < _menuParents.length; _index++) {
    _loop3(_index);
  }
} //PRICE FILTERS=======================================


if (document.querySelector('.section-filter')) {
  if (isMobileOrTablet()) {
...
var searchSelect = document.querySelector('.search-page__title');
...
var _loop4 = function _loop4(_index2) {
  ...
  checkboxCategory.addEventListener('change', function (e) {
    ...
    if (checkboxActiveCategories.length > 0) {
      ...
      var searchTotal = searchSelect.querySelector('.title-search__total');
      searchTotal.innerHTML = searchTotal.getAttribute('data-text') + ' ' + checkboxActiveCategories.length;
    } else {
...
for (var _index2 = 0; _index2 < checkboxCategories.length; _index2++) {
  _loop4(_index2);
} //ibg=======================================
...
if (spollers.length > 0) {
  var _loop5 = function _loop5(_index3) {
    var spoller = spollers[_index3];
    spoller.addEventListener("click", function (e) {
      ...
      if (spoller.closest('._spollers').classList.contains('_one')) {
        var current_spollers = spoller.closest('._spollers').querySelectorAll('._spoller');

        for (var i = 0; i < current_spollers.length; i++) {
          var el = current_spollers[i];
  ...
  for (var _index3 = 0; _index3 < spollers.length; _index3++) {
    _loop5(_index3);
  }
} // END SPOLLERS ==================================================================
//   ==================================================================
...
if (document.querySelector('.mainslider')) {
  ...
  var mainsliderImages = document.querySelectorAll('.mainslider__image');
  var mainsliderDots = document.querySelectorAll('.mainslider__dots .swiper-pagination-bullet');

  for (var _index4 = 0; _index4 < 5; _index4++) {
    var mainsliderImage = mainsliderImages[_index4 + 1].querySelector('img').getAttribute('src');

    mainsliderDots[_index4].style.backgroundImage = "url('" + mainsliderImage + "')";
  }
} //end Mainslider======================================================================
//end imagesMainslider======================================================================
...
if (quantityButtons.length > 0) {
  var _loop6 = function _loop6(_index5) {
...
if (document.querySelector('._tabs')) {
  ...
  var _loop7 = function _loop7(_index6) {
    var tab = tabs[_index6];
    var tabs_items = document.querySelectorAll('._tabs-item');
    var tabs_blocks = document.querySelectorAll('._tabs-block');

    var _loop8 = function _loop8(_index7) {
      var tabs_item = tabs_items[_index7];
      tabs_item.addEventListener('click', function (e) {
        for (var _index8 = 0; _index8 < tabs_items.length; _index8++) {
          var _tabs_item = tabs_items[_index8];

          _tabs_item.classList.remove('_active');

          tabs_blocks[_index8].classList.remove('_active');
        }

        tabs_item.classList.add('_active');

        tabs_blocks[_index7].classList.add('_active');
  ...
  for (var _index6 = 0; _index6 < tabs.length; _index6++) {
    _loop7(_index6);
  }
} // END tabs ==================================================================